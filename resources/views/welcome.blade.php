...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    ...
    @vite('resources/js1/jquery.min.js')

    @vite('resources/js1/bootstrap.min.js')
    @vite('resources/js1/pace.min.js')
    @vite('resources/js1/Chart.min.js')
    @vite('resources/js1/template.js')
